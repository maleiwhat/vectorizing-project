...
public:
	...
	static HRESULT          CreateIMEEditBox(CDXUTDialog* pDialog, int ID,
	...
	static  bool WINAPI     StaticMsgProc(HWND hWnd, UINT uMsg, WPARAM wParam,
	                                      LPARAM lParam);
	...
	virtual bool            HandleMouse(UINT uMsg, POINT pt, WPARAM wParam,
	                                    LPARAM lParam);
	...
	virtual void            RenderCandidateReadingWindow(float fElapsedTime,
	        bool bReading);

...
/// RGB2LAB
//===========================================================================
void SLIC::RGB2LAB(const int& sR, const int& sG, const int& sB, double& lval, double& aval,
				   double& bval)
{
	//------------------------
	...
	const double&               compactness)
{
	...
	//std::vector<double> distvec(sz, DBL_MAX);
	double invwt = 1.0 / ((STEP / compactness) * (STEP /
						  compactness)); //compactness = 20.0 is usually good.
	...
	const double&               compactness)
{
	...
	GetLABXYSeeds_ForGivenStepSize(kseedsl, kseedsa, kseedsb, kseedsx, kseedsy, STEP, perturbseeds,
								   edgemag);
	//system("pause");
	PerformSuperpixelSLIC(kseedsl, kseedsa, kseedsb, kseedsx, kseedsy, klabels, STEP, edgemag,
						  compactness);
	//system("pause");
	...
	const double&                                   compactness)//weight given to spatial distance
{
	...
	DoSuperpixelSegmentation_ForGivenSuperpixelSize(ubuff, width, height, klabels, numlabels,

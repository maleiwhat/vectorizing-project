...
double_vector SmoothingLoop(const double_vector& data, int repeat = 1);
double_vector SmoothingLen3(const double_vector& data, int repeat = 1);
double_vector SmoothingLen5(const double_vector& data, int repeat = 1);

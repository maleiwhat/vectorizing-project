...
void CFileView::FillFileView()
{
	...
	HTREEITEM hSrc = m_wndFileView.InsertItem(_T("FakeApp 原始程式檔"), 0, 0,
	                 hRoot);
...
void CFileView::OnContextMenu(CWnd* pWnd, CPoint point)
{
	...
	pWndTree->SetFocus();
	theApp.GetContextMenuManager()->ShowPopupMenu(IDR_POPUP_EXPLORER, point.x,
	        point.y, this, TRUE);
}
...
void CFileView::AdjustLayout()
{
	...
	m_wndFileView.SetWindowPos(NULL, rectClient.left + 1,
	                           rectClient.top + cyTlb + 1, rectClient.Width() - 2,
...
void CFileView::OnChangeVisualStyle()
{
	...
	m_wndToolBar.LoadBitmap(theApp.m_bHiColorIcons ? IDB_EXPLORER_24 : IDR_EXPLORER,
	                        0, 0, TRUE /* 鎖定 */);

...
{
public:
	BgDialog(wxWindow*, wxWindowID, const wxString&, const wxPoint&, const wxSize&,
	         long, const wxString&);
	~BgDialog(void);
...
public:
	...
	BgImCanvas(wxWindow* child_frame, wxWindow* parent, const wxPoint& pos,
	           const wxSize& size);
	~BgImCanvas();
...
{
public:
	BgParameterHistoryBox(wxWindow*, wxWindowID, const wxString&, const wxPoint&,
	                      const wxSize&, int, long, const wxValidator&, const wxString&);
...
public:
	...
	void SetValues(double, double, double, double, double, double, int, int, int,
	               int, int);
	void GetValues(double&, double&, double&, double&, double&, double&, int&, int&,
	               int&, int&, int&);
...
public:
	...
	BgMdiEdgeChild(wxMDIParentFrame* parent, const wxString& title,
	               const wxPoint& pos, const wxSize& size, const long style);
	~BgMdiEdgeChild();
	void OnQuit(wxCommandEvent&);
	void OnClose(wxCloseEvent&);
...
public:
	...
	BgMdiSegmentChild(wxMDIParentFrame* parent, const wxString& title,
	                  const wxPoint& pos, const wxSize& size, const long style);
	~BgMdiSegmentChild();

...
//--------------------------------------------------------------------------------------
void CD3DSettingsDlg::Init(CDXUTDialogResourceManager* pManager,
                           LPCWSTR pszControlTextureResourcename, HMODULE hModule)
{
	assert(pManager);
...
void CD3DSettingsDlg::CreateControls()
{
	...
	m_Dialog.AddRadioButton(DXUTSETTINGSDLG_WINDOWED,
	                        DXUTSETTINGSDLG_WINDOWED_GROUP, L"Windowed", 240, 115, 300, 16);
	m_Dialog.AddCheckBox(DXUTSETTINGSDLG_DEVICECLIP,
	                     L"Clip to device when window spans across multiple monitors", 250, 136, 400,
	                     16);
	m_Dialog.AddRadioButton(DXUTSETTINGSDLG_FULLSCREEN,
	                        DXUTSETTINGSDLG_WINDOWED_GROUP, L"Full Screen", 240, 157, 300, 16);
	...
	m_Dialog.AddStatic(DXUTSETTINGSDLG_D3D10_ADAPTER_OUTPUT_LABEL,
	...
	m_Dialog.AddStatic(DXUTSETTINGSDLG_D3D10_RESOLUTION_LABEL, L"Resolution", 10,
	                   200, 180, 23);
	...
	// DXUTSETTINGSDLG_D3D10_REFRESH_RATE
	m_Dialog.AddStatic(DXUTSETTINGSDLG_D3D10_REFRESH_RATE_LABEL, L"Refresh Rate",
	                   10, 225, 180, 23);
	m_Dialog.AddComboBox(DXUTSETTINGSDLG_D3D10_REFRESH_RATE, 200, 225, 300, 23);
	// DXUTSETTINGSDLG_D3D10_BACK_BUFFER_FORMAT
	m_Dialog.AddStatic(DXUTSETTINGSDLG_D3D10_BACK_BUFFER_FORMAT_LABEL,
	                   L"Back Buffer Format", 10, 260, 180, 23);
	m_Dialog.AddComboBox(DXUTSETTINGSDLG_D3D10_BACK_BUFFER_FORMAT, 200, 260, 300,
	                     23);
	// DXUTSETTINGSDLG_D3D10_MULTISAMPLE_COUNT
	m_Dialog.AddStatic(DXUTSETTINGSDLG_D3D10_MULTISAMPLE_COUNT_LABEL,
	                   L"Multisample Count", 10, 285, 180, 23);
	m_Dialog.AddComboBox(DXUTSETTINGSDLG_D3D10_MULTISAMPLE_COUNT, 200, 285, 300,
	                     23);
	// DXUTSETTINGSDLG_D3D10_MULTISAMPLE_QUALITY
	m_Dialog.AddStatic(DXUTSETTINGSDLG_D3D10_MULTISAMPLE_QUALITY_LABEL,
	                   L"Multisample Quality", 10, 310, 180, 23);
	m_Dialog.AddComboBox(DXUTSETTINGSDLG_D3D10_MULTISAMPLE_QUALITY, 200, 310, 300,
	                     23);
	// DXUTSETTINGSDLG_D3D10_PRESENT_INTERVAL
	m_Dialog.AddStatic(DXUTSETTINGSDLG_D3D10_PRESENT_INTERVAL_LABEL,
	...
	m_Dialog.AddCheckBox(DXUTSETTINGSDLG_D3D10_DEBUG_DEVICE, L"Create Debug Device",
	                     200, 365, 180, 23);
...
HRESULT CD3DSettingsDlg::Refresh()
{
	...
	case DXUT_D3D9_DEVICE:
	{
		...
		CD3D9EnumDeviceSettingsCombo* pBestDeviceSettingsCombo =
		    pD3DEnum->GetDeviceSettingsCombo(g_DeviceSettings.d3d9.AdapterOrdinal,
		                                     g_DeviceSettings.d3d9.DeviceType, g_DeviceSettings.d3d9.AdapterFormat,
	...
	case DXUT_D3D10_DEVICE:
	{
		...
		AddD3D10AdapterOutput(pOutputInfo->Desc.DeviceName,
		...
		CD3D10EnumDeviceSettingsCombo* pBestDeviceSettingsCombo =
		    pD3DEnum->GetDeviceSettingsCombo(g_DeviceSettings.d3d10.AdapterOrdinal,
		                                     g_DeviceSettings.d3d10.DriverType, g_DeviceSettings.d3d10.Output,
		...
		pAdapterCombo->SetSelectedByData(ULongToPtr(
		                                     g_DeviceSettings.d3d10.AdapterOrdinal));
		hr = OnAPIVersionChanged(true);
...
HRESULT CD3DSettingsDlg::OnD3D10CreateDevice(ID3D10Device* pd3dDevice)
{
	...
	DXUT_Dynamic_D3D10StateBlockMaskEnableCapture(&SBM,
	        D3D10_DST_RS_RASTERIZER_STATE, 0, 1);
	V_RETURN(DXUT_Dynamic_D3D10CreateStateBlock(pd3dDevice, &SBM,
	         &m_pStateBlock10));
	return S_OK;
}
...
void CD3DSettingsDlg::ShowControlSet(DXUTDeviceVersion ver)
{
	...
	case DXUT_D3D9_DEVICE:
		...
		m_Dialog.GetControl(DXUTSETTINGSDLG_D3D10_ADAPTER_OUTPUT_LABEL)->SetVisible(
		    false);
		...
		m_Dialog.GetControl(DXUTSETTINGSDLG_D3D10_REFRESH_RATE_LABEL)->SetVisible(
		    false);
		m_Dialog.GetControl(DXUTSETTINGSDLG_D3D10_BACK_BUFFER_FORMAT)->SetVisible(
		    false);
		m_Dialog.GetControl(DXUTSETTINGSDLG_D3D10_BACK_BUFFER_FORMAT_LABEL)->SetVisible(
		    false);
		m_Dialog.GetControl(DXUTSETTINGSDLG_D3D10_MULTISAMPLE_COUNT)->SetVisible(false);
		m_Dialog.GetControl(DXUTSETTINGSDLG_D3D10_MULTISAMPLE_COUNT_LABEL)->SetVisible(
		    false);
		m_Dialog.GetControl(DXUTSETTINGSDLG_D3D10_MULTISAMPLE_QUALITY)->SetVisible(
		    false);
		m_Dialog.GetControl(
		    DXUTSETTINGSDLG_D3D10_MULTISAMPLE_QUALITY_LABEL)->SetVisible(false);
		m_Dialog.GetControl(DXUTSETTINGSDLG_D3D10_PRESENT_INTERVAL)->SetVisible(false);
		m_Dialog.GetControl(DXUTSETTINGSDLG_D3D10_PRESENT_INTERVAL_LABEL)->SetVisible(
		    false);
	...
	case DXUT_D3D10_DEVICE:
		...
		m_Dialog.GetControl(DXUTSETTINGSDLG_D3D10_MULTISAMPLE_QUALITY)->SetVisible(
		    true);
		m_Dialog.GetControl(
		    DXUTSETTINGSDLG_D3D10_MULTISAMPLE_QUALITY_LABEL)->SetVisible(true);
                              ...
                              CDXUTControl* pControl)
{
	...
	case DXUTSETTINGSDLG_DEVICE_TYPE:                    OnDeviceTypeChanged();
		break;
	...
	case DXUTSETTINGSDLG_ADAPTER_FORMAT:                 OnAdapterFormatChanged();
		break;
	...
	case DXUTSETTINGSDLG_RESOLUTION:                     OnResolutionChanged();
		break;

	case DXUTSETTINGSDLG_REFRESH_RATE:                   OnRefreshRateChanged();
		break;
	...
	case DXUTSETTINGSDLG_MULTISAMPLE_TYPE:               OnMultisampleTypeChanged();
		break;
	...
	case DXUTSETTINGSDLG_PRESENT_INTERVAL:               OnPresentIntervalChanged();
		break;

	case DXUTSETTINGSDLG_DEVICECLIP:                     OnDeviceClipChanged();
		break;

	case DXUTSETTINGSDLG_API_VERSION:                    OnAPIVersionChanged();
		break;

	case DXUTSETTINGSDLG_D3D10_ADAPTER_OUTPUT:           OnAdapterOutputChanged();
		break;

	case DXUTSETTINGSDLG_D3D10_RESOLUTION:               OnD3D10ResolutionChanged();
		break;

	case DXUTSETTINGSDLG_D3D10_REFRESH_RATE:             OnRefreshRateChanged();
		break;

	case DXUTSETTINGSDLG_D3D10_BACK_BUFFER_FORMAT:
		OnBackBufferFormatChanged(); break;

	case DXUTSETTINGSDLG_D3D10_MULTISAMPLE_COUNT:        OnMultisampleTypeChanged();
		break;

	case DXUTSETTINGSDLG_D3D10_MULTISAMPLE_QUALITY:
		OnMultisampleQualityChanged(); break;

	case DXUTSETTINGSDLG_D3D10_PRESENT_INTERVAL:         OnPresentIntervalChanged();
		break;

	case DXUTSETTINGSDLG_D3D10_DEBUG_DEVICE:             OnDebugDeviceChanged();
		break;
...
//-------------------------------------------------------------------------------------
CD3D10EnumDeviceSettingsCombo*
CD3DSettingsDlg::GetCurrentD3D10DeviceSettingsCombo()
{
	CD3D10Enumeration* pD3DEnum = DXUTGetD3D10Enumeration();
...
HRESULT CD3DSettingsDlg::OnAPIVersionChanged(bool bRefresh)
{
	...
	case DXUT_D3D9_DEVICE:
	{
		if (!bRefresh)
		{
			...
			DXUTFindValidDeviceSettings(&g_DeviceSettings, &g_DeviceSettings,
			                            &MatchOptions);
		}
	...
	case DXUT_D3D10_DEVICE:
	{
		...
		CDXUTCheckBox* pCheckBox = m_Dialog.GetCheckBox(
		                               DXUTSETTINGSDLG_D3D10_DEBUG_DEVICE);
		pCheckBox->SetChecked(0 != (g_DeviceSettings.d3d10.CreateFlags &
...
HRESULT CD3DSettingsDlg::OnWindowedFullScreenChanged()
{
	...
	m_Dialog.SetControlEnabled(DXUTSETTINGSDLG_D3D10_ADAPTER_OUTPUT_LABEL,
	                           !bWindowed);
	m_Dialog.SetControlEnabled(DXUTSETTINGSDLG_D3D10_RESOLUTION_LABEL, !bWindowed);
	m_Dialog.SetControlEnabled(DXUTSETTINGSDLG_D3D10_REFRESH_RATE_LABEL,
	                           !bWindowed);
		...
		else
		{
			        ...
			        iSettingsCombo++)
			{
				CD3D9EnumDeviceSettingsCombo* pSettingsCombo =
				    pDeviceInfo->deviceSettingsComboList.GetAt(iSettingsCombo);
...
HRESULT CD3DSettingsDlg::OnAdapterOutputChanged()
{
	...
	const DXGI_RATIONAL RefreshRate =
	    g_DeviceSettings.d3d10.sd.BufferDesc.RefreshRate;
	CD3D10EnumAdapterInfo* pAdapterInfo = GetCurrentD3D10AdapterInfo();
...
HRESULT CD3DSettingsDlg::OnBackBufferFormatChanged()
{
	...
	case DXUT_D3D9_DEVICE:
	{
		...
		for (int idc = 0; idc < pDeviceInfo->deviceSettingsComboList.GetSize(); idc++)
		{
			        ...
			        pDeviceCombo->BackBufferFormat == backBufferFormat)
			{
				...
				CDXUTComboBox* pVertexProcessingComboBox = m_Dialog.GetComboBox(
				            DXUTSETTINGSDLG_VERTEX_PROCESSING);
	...
	{
		g_DeviceSettings.d3d10.sd.BufferDesc.Format =
		    GetSelectedD3D10BackBufferFormat();
		...
		for (int idc = 0; idc < pAdapterInfo->deviceSettingsComboList.GetSize(); idc++)
		{
			        ...
			        pDeviceCombo->DeviceType == g_DeviceSettings.d3d10.DriverType)
			{
				...
				pPresentIntervalComboBox->SetSelectedByData(ULongToPtr(
				            g_DeviceSettings.d3d10.SyncInterval));
				hr = OnPresentIntervalChanged();
...
HRESULT CD3DSettingsDlg::OnMultisampleTypeChanged()
{
	...
	case DXUT_D3D10_DEVICE:
	{
		...
		CD3D10EnumDeviceSettingsCombo* pDeviceSettingsCombo =
		    GetCurrentD3D10DeviceSettingsCombo();
		...
		pMultisampleQualityCombo->SetSelectedByData(ULongToPtr(
		            g_DeviceSettings.d3d10.sd.SampleDesc.Quality));
		hr = OnMultisampleQualityChanged();
...
HRESULT CD3DSettingsDlg::OnMultisampleQualityChanged()
{
	...
	case DXUT_D3D10_DEVICE:
		g_DeviceSettings.d3d10.sd.SampleDesc.Quality =
		    GetSelectedD3D10MultisampleQuality();
		break;
	}
...
//-------------------------------------------------------------------------------------
void CD3DSettingsDlg::GetSelectedD3D10Resolution(DWORD* pdwWidth,
        DWORD* pdwHeight)
{
	CDXUTComboBox* pComboBox = m_Dialog.GetComboBox(
	                               DXUTSETTINGSDLG_D3D10_RESOLUTION);
...
void CD3DSettingsDlg::AddD3D10RefreshRate(DXGI_RATIONAL RefreshRate)
{
	...
	{
		StringCchPrintf(strRefreshRate, 50, L"%d Hz",
...
HRESULT CD3DSettingsDlg::UpdateD3D10Resolutions()
{
	...
	DXUTGetDesktopResolution(g_DeviceSettings.d3d10.AdapterOrdinal,
	...
	const DWORD dwCurResolution = MAKELONG(
	                                  g_DeviceSettings.d3d10.sd.BufferDesc.Width,
	                                  g_DeviceSettings.d3d10.sd.BufferDesc.Height);
	pResolutionComboBox->SetSelectedByData(ULongToPtr(dwCurResolution));
...
WCHAR* DXUTVertexProcessingTypeToString(DWORD vpt)
{
	...
	case D3DCREATE_PUREDEVICE:                return
		    L"Pure hardware vertex processing";

	default:                                  return
		    L"Unknown vertex processing type";
	}
}

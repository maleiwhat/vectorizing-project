...
ID3D10EffectVectorVariable* CDXUTDirectionWidget::g_pMaterialDiffuseColor =
    NULL;
...
ID3D10EffectMatrixVariable* CDXUTDirectionWidget::g_pmWorldViewProjection =
    NULL;
        ...
        pd3dDevice)
{
	...
	V_RETURN(D3DXCreateEffect(s_pd3d9Device, g_strBuffer, dwBufferSize, NULL, NULL,
	                          D3DXFX_NOT_CLONEABLE, NULL, &s_pD3D9Effect, NULL));
	...
	V(s_pD3D9Mesh->OptimizeInplace(D3DXMESHOPT_VERTEXCACHE, rgdwAdjacency, NULL,
	                               NULL, NULL));
...
//--------------------------------------------------------------------------------------
HRESULT CDXUTDirectionWidget::StaticOnD3D10CreateDevice(
    ID3D10Device* pd3dDevice)
{
	...
	const char* g_strBuffer =
	    ...
	    "";
	UINT dwBufferSize = (UINT)strlen(g_strBuffer) + 1;
	HRESULT hr = D3DX10CreateEffectFromMemory(g_strBuffer, dwBufferSize, "None",
	             NULL, NULL, "fx_4_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, pd3dDevice, NULL, NULL,
	...
	g_pMaterialDiffuseColor =
	    s_pD3D10Effect->GetVariableByName("g_MaterialDiffuseColor")->AsVector();
	...
	g_pmWorldViewProjection =
	    s_pD3D10Effect->GetVariableByName("g_mWorldViewProjection")->AsMatrix();
...
//--------------------------------------------------------------------------------------
HRESULT CDXUTDirectionWidget::OnRender10(D3DXCOLOR color,
        const D3DXMATRIX* pmView, const D3DXMATRIX* pmProj, const D3DXVECTOR3* pEyePt)
{
	m_mView = *pmView;

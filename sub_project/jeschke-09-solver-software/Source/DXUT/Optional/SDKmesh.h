...
struct SDKMESH_VERTEX_BUFFER_HEADER
{
	...
	{
		UINT64
		DataOffset;             //(This also forces the union to 64bits)
...
//--------------------------------------------------------------------------------------
typedef void (CALLBACK* LPCREATETEXTUREFROMFILE9)(IDirect3DDevice9* pDev,
        char* szFileName, IDirect3DTexture9** ppTexture, void* pContext);
typedef void (CALLBACK* LPCREATEVERTEXBUFFER9)(IDirect3DDevice9* pDev,
        IDirect3DVertexBuffer9** ppBuffer, UINT iSizeBytes, DWORD Usage, DWORD FVF,
        D3DPOOL Pool, void* pData, void* pContext);
typedef void (CALLBACK* LPCREATEINDEXBUFFER9)(IDirect3DDevice9* pDev,
        IDirect3DIndexBuffer9** ppBuffer, UINT iSizeBytes, DWORD Usage,
        D3DFORMAT ibFormat, D3DPOOL Pool, void* pData, void* pContext);
...
typedef void (CALLBACK* LPCREATETEXTUREFROMFILE10)(ID3D10Device* pDev,
        char* szFileName, ID3D10ShaderResourceView** ppRV, void* pContext);
typedef void (CALLBACK* LPCREATEVERTEXBUFFER10)(ID3D10Device* pDev,
        ID3D10Buffer** ppBuffer, D3D10_BUFFER_DESC BufferDesc, void* pData,
        void* pContext);
typedef void (CALLBACK* LPCREATEINDEXBUFFER10)(ID3D10Device* pDev,
        ID3D10Buffer** ppBuffer, D3D10_BUFFER_DESC BufferDesc, void* pData,
        void* pContext);
...
protected:
	...
	HRESULT CreateIndexBuffer(ID3D10Device* pd3dDevice,
	...
	virtual HRESULT CreateFromFile(ID3D10Device* pDev10, IDirect3DDevice9* pDev9,
	                               LPCTSTR szFileName, bool bOptimize, bool bCreateAdjacencyIndices,
...
public:
	...
	virtual HRESULT Create(ID3D10Device* pDev10, LPCTSTR szFileName,
	                       bool bOptimize = true, bool bCreateAdjacencyIndices = false,
	                       SDKMESH_CALLBACKS10* pLoaderCallbacks = NULL);
	virtual HRESULT Create(IDirect3DDevice9* pDev9, LPCTSTR szFileName,
	                       bool bOptimize = true, bool bCreateAdjacencyIndices = false,
	                       SDKMESH_CALLBACKS9* pLoaderCallbacks = NULL);
	virtual HRESULT Create(ID3D10Device* pDev10, BYTE* pData, UINT DataBytes,
	                       bool bOptimize = true, bool bCreateAdjacencyIndices = false,
	                       bool bCopyStatic = false, SDKMESH_CALLBACKS10* pLoaderCallbacks = NULL);
	virtual HRESULT Create(IDirect3DDevice9* pDev9, BYTE* pData, UINT DataBytes,
	                       bool bOptimize = true, bool bCreateAdjacencyIndices = false,
	                       bool bCopyStatic = false, SDKMESH_CALLBACKS9* pLoaderCallbacks = NULL);
	...
	static D3D10_PRIMITIVE_TOPOLOGY GetPrimitiveType10(SDKMESH_PRIMITIVE_TYPE
	        PrimType);
